...
<body>
						...
						<div class="user-panel">
							...
							<div class="up-item">
								<div class="shopping-card">
									...
									<span id="soLuongSanPhamThemVaoGioHang">${soLuongSanPham }</span>
								</div>
	...
	<section class="product-section">
		<div class="container">
			<div class="back-link">
				<a href="/shoponline/"> &lt;&lt; Back to Category</a>
			</div>
			<div class="row">
					<div class="col-lg-6">
						<div class="product-pic-zoom">
							<img class="product-big-img imageProduct" data-image="${product.image }" src="<c:url value='/resources/image/products/${product.image }'/>" alt="">
						</div>
						<div class="product-thumbs" tabindex="1" style="overflow: hidden; outline: none;">
						</div>
					</div>
				 <div class="col-lg-6 product-details">
					<h2 class="p-title productName" data-idPd="${product.getId()}">${product.productName}</h2>
					<h3 class="p-price productPrice" data-price="${product.price }">$${product.price }</h3>
					...
					<div class="fw-size-choose">
						<table class="table">
						    ...
						    <tbody>
						     <c:forEach items="${ product.getProductsDetail()}" var="productDetail">
							      <tr class="danger">
							        <td class="sizeName" data-IdS="${productDetail.getSize().getId() }" data-prDtID="${productDetail.getId() }">${productDetail.getSize().getSizeName()}</td>
							        <td class="colorName" data-idC="${productDetail.getColor().getId() }">${productDetail.getColor().getColorName()}</td>
							        <td>${productDetail.getSoLuong()}</td>
							        <td><button type="button" class="btn btn-outline-danger btn-add-giohang">Thêm Giỏ Hàng</button></td>
							      </tr>
						      </c:forEach>
						    </tbody>
						 </table>
	...
	<section class="related-product-section">
		<div class="container">
			...
			<div class="product-slider owl-carousel">
				...
				<div class="product-item">
					<div class="pi-pic">
						<img src="<c:url value='/resources/home/img/product/3.jpg'/>" alt="">
						<div class="pi-links">
							<a href="#" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
							<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
						</div>
				...
				<div class="product-item">
						<div class="pi-pic">
							<img src="<c:url value='/resources/home/img/product/4.jpg'/>" alt="">
							<div class="pi-links">
								<a href="#" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
								<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
							</div>
				...
				<div class="product-item">
					<div class="pi-pic">
						<img src="<c:url value='/resources/home/img/product/6.jpg'/>" alt="">
						<div class="pi-links">
							<a href="#" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
							<a href="#" class="wishlist-btn"><i class="flaticon-heart"></i></a>
						</div>
